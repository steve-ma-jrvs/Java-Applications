...
public class OrderDAO extends DataAccessObject<Order> {
  ...
  private final static String GET_BY_ID = new StringBuilder()
      .append("SELECT c.first_name, c.last_name, c.email, o.order_id, o.creation_date, ").append(
      ...
      .append("on ol.product_id = p.product_id where o.order_id = ?").toString();
